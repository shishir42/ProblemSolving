...
public class MinCostToReachLastCellI2DArrayBottomUp {
    public static void main(String[] args) {
        MinCostToReachLastCellI2DArrayBottomUpSol sol = new MinCostToReachLastCellI2DArrayBottomUpSol();
        int[][] array =
			{
				{ 4, 7, 8, 6, 4 },
				{ 6, 7, 3, 9, 2 },
		...
		System.out.print("The minimum cost is " + sol.findMinCost(array, array.length, array[0].length));  
    }
}

class MinCostToReachLastCellI2DArrayBottomUpSol{
