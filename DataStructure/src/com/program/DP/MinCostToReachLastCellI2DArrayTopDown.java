...
public class MinCostToReachLastCellI2DArrayTopDown {
    public static void main(String[] args) {
        MinCostToReachLastCellI2DArrayTopDownSol sol = new MinCostToReachLastCellI2DArrayTopDownSol();
        int[][] array =
			{
				{ 4, 7, 8, 6, 4 },
				{ 6, 7, 3, 9, 2 },
            ...
            System.out.print("The minimum cost is " + sol.findMinCost(array, array.length - 1, array[0].length - 1));
    }
}

class MinCostToReachLastCellI2DArrayTopDownSol{
