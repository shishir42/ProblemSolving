...
public class PathFindingByBellmanFord {
	...
	public static void main(String[] args) {
		...
		//Constructor
		PathFindingByBellmanFordMain graph = new PathFindingByBellmanFordMain(nodeList);
...
class PathFindingByBellmanFordMain {

	//Will store all the vertices
	ArrayList<WeightedNode> nodeList = new ArrayList<WeightedNode>();

	//Constructor
	public PathFindingByBellmanFordMain(ArrayList<WeightedNode> nodeList) {
