...
public class NumberOfPathsToReachLastCell {
	public static void main(String[] args) {
		int[][] array = { 
				  ...
				  { 7, 1, 6, 3 } };
		int cost = 25;
		NumberOfPathsToReachLastCellMain sol = new NumberOfPathsToReachLastCellMain();
		System.out.println("Total paths with cost " + cost + " are " + sol.numberOfPaths(array, array.length - 1, array[0].length - 1, cost));
	}
}

class NumberOfPathsToReachLastCellMain{
